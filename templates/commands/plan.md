...
6. 계획 파일 작성 (`.claude/plans/`에 Plan Mode 기본 방식대로)
   - 반드시 포함: Task ID, PRD 참조 섹션, 수용 기준(AC)

7. 사용자 승인 (ExitPlanMode)

8. **Plan Mode에서 작성한 계획을 그대로** `docs/plans/PLAN_$ARGUMENTS.md`로 복사
